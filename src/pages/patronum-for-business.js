...
import PatronumForBusinessHero from "@/components/Illustrations/PatronumForBusinessHero";
const Faqs = dynamic(
  ...
  return (
    <>
      <MetaData
        ...
        description={
          "Patronum for Business empowers companies with smart automation and a sophisticated interface, cutting through technical challenges to ensure effective digital workspace governance."
        }
      ...
      <Layout>
        <main>
          <Hero
            ...
            svgElement={<PatronumForBusinessHero className={"h-full w-full"} />}
          />
