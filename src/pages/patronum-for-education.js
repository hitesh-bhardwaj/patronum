...
import PatronumForEducationHero from "@/components/Illustrations/PatronumForEducationHero";
const Faqs = dynamic(
  ...
  return (
    <>
      ...
      <MetaData
        ...
        description={
          "Patronum for Education simplifies Google Workspace management, alleviating the burden of manual setup and constant adjustments, and automating processes from email signatures to resource allocation, enhancing education quality."
        }
      ...
      <Layout>
        <main>
          <Hero
            ...
            svgElement={
              <PatronumForEducationHero className={"h-full w-full"} />
            }
          />
