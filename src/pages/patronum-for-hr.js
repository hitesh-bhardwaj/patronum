...
import PatronumForHrHero from "@/components/Illustrations/PatronumForHrHero";
const Faqs = dynamic(
  ...
  return (
    <>
      ...
      <MetaData
        ...
        description={
          "Patronum for HR - Patronum acts as a bridge between your HR system and Google Workspace, automating onboarding, offboarding, and employee management, enabling focus on strategic initiatives."
        }
        url={"patronum-for-hr"}
        ...
        <main>
          <Hero
            ...
            breadcrumbLink={"use-cases"}
             svgElement={
              <PatronumForHrHero className={"h-full w-full"} />
            }
          />
