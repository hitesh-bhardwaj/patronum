...
const rowData = [
    {
      ...
      img1: true, 
      img2: false, 
      info2:"Bettercloud does not provide pricing on website and offers several packages and bundles"
    },
    {
      ...
      img1: true, 
      img2: false, 
      info2:"Trial is available, only via request after sales demo."
    },
    {
    ...
    return (
        <>
            <PageLayout
                ...
                pageTitle2="your alternative to Bettercloud is here!!"
                pagePara=" "
                imgSrc="/about.svg"
            ...
            >
                <Comparison data={rowData} product={"Bettercloud"} productprice={"$72"} productpriceInfo={"Pricing depends on tiers, lower tiers do not include on or offboarding capabilities, middle tier offers closest feature set to Patronum"}/>
                <ProductFeatures/>
            </PageLayout>
        </>
    )
