...
const rowData = [
    {
      ...
      img1: true, 
      img2: false, 
      info2:"CloudM does not provide pricing on website and offers several packages and bundles"
    },
    {
      ...
      img1: true, 
      img2: false, 
      info2:"30 Day Trial but for only 2 users. We don't think you can fully evaluate a product like this. That is why our free trial is exactly the same as the full product."
    },
    {
...
export default function CloudMManage() {

    return (
        <>
            <PageLayout
                pageTitle1="Look no further,"
                pageTitle2="your alternative for CloudM Manage is here!!"
                pagePara=" "
                imgSrc=""
            ...
            >
                <Comparison data={rowData} product={"CloudM Manage"} productprice={"$16"} productpriceInfo={"$16 for CloudM Manage, additional costs for CloudM Archive."}/>
                <ProductFeatures/>
