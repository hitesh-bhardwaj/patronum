...
import WebinarHero from "@/components/Illustrations/WebinarHero";
          ...
          >
            ...
            <div className="text-container px-[8%] lg:py-[4%] lg:pb-[6%] py-[8%] lg:space-y-[2vw] space-y-[5%] flex justify-between flex-col">
              ...
              <div className="lg:space-y-[2vw] space-y-[5%]">
                ...
                <LinkButton href="javascript:void(0)" btnText="Watch Webinar" />
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <>
      ...
      <MetaData
        ...
        description={
          "Check out our latest webinars and videos, or register for upcoming sessions to hear insights from industry experts."
        }
        url={"webinars"}
        img={"homepage.jpg"}
      ...
      <Layout>
        <main>
          <Hero
            ...
            imgSrc="webinars.svg"
           svgElement={
              <WebinarHero className={"h-full w-full"} />
            }
          />
...
const Details = [
  {
    title:
      "One Tool To Rule Them All - The Easy Way To Manage Google Workspace",
    ...
    content:
      "In this webinar, we explore all the current features within Patronum that help manage your Google Workspace environment.",
    videoId: "dPXBVDFe_h8",
  },
  {
    ...
    content:
      "In this webinar we explain the difference between Google Profiles, Google Domain Contacts (Domain Shared Domains) and Google Contacts. We go into depth about how, using Patronum, workflows can be configured to automatically share Google Contacts with other users.",
    videoId: "_oiMzVIhizM",
  },
  {
    ...
    content:
      "This webinar explores how Patronum can help simplify and secure user offboarding within Google Workspace. By watching, you'll learn new approaches to: Declutter calendar events, Keep your contact database up to date, Manage Google Drive file access.",
    videoId: "cLMtzYrI6as",
  },
  {
    ...
    content:
      "In this webinar we explore how Patronum can help Google Workspace administrators keep their Google Drive data under control. We explore who to set alerts around storage limits and item restrictions.",
    videoId: "v3Xlz8ExUzI",
  },
  {
    ...
    content:
      "In this webinar, we explore how Patronum can help simplify user onboarding within Google Workspace. By Quickly set up and deploy Patronum new user templates and many other things.",
    videoId: "tln9zjC8Cik",
  },
  {
    ...
    content:
      "In this webinar we explore how Patronum can help identify and mitigate against the common challenge of Google Workspace users oversharing files from Google Drive.",
    videoId: "gutE4jdoRgs",
  },
  {
    ...
    content:
      "In this video, we explore how to create professional email signatures for all your Google Workspace Gmail users using the Patronum policy manager.",
    videoId: "wclSm5PfbOo",
  },
  {
    ...
    content:
      "In this video, Fintan and Paul discuss the role of the IT Admin, how it's changed over the years and some of the unique challenges now facing individuals in the role.",
    videoId: "uRql8BR8XBE",
  },
  {
    title:
      "Paul Lees founder of Bespin Labs talks about his own Technology and Google Journey",
