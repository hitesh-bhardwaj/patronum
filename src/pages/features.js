                        ...
                        <div className="content">
                            <div className="featuresPage-top">
                                ...
                                <div className="paraSectionHead">
                                    <p className="aeonik font-[400] text-anim-2">Transform your Google Workspace experience with Patronum, the ultimate solution to your onboarding nightmares, permission hassles, and data compliance woes. Patronum is designed to streamline the management of Google Workspace.</p>
                                </div>
                            </div>
                        </div>
                    </div>
