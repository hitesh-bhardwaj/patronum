...
import BackupCard from "@/components/ContactTrial/OnBoarding/BackupCard";
    ...
    <>
     ...
     <Head>
      ...
      <Layout>
        ...
        <TransformV2 text={"Sleep Easy. Your Data’s Always Protected."} content={"Human error? Malicious deletion? No problem. Patronum gives you ironclad full-fidelity Google Workspace backups—because second chances shouldn’t be optional."}/>
                        <SectionBreak
