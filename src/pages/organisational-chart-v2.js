...
import { OrganisationalChart } from "@/components/Illustrations/OrganisationalChart";
      ...
      <Layout>
        <main>
         ...
         <VideoPlayer disabled={true} videoCover={"/assets/features/organisational-chart/video-cover.webp"} />
                ...
                <TransformV2 text={"Visualise Your Team. Empower Your People!"} content={"Bring clarity to your workforce. Patronum's live org chart helps teams understand roles, relationships, and reporting lines to improve collaboration."}/>
