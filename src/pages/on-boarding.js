...
import { Onboarding } from "@/components/Illustrations/OnBoarding";
...
const OnBoardingV2 = () => {
  return (
    <>
      <MetaData
        title={
          "Automate User Onboarding and Offboarding in Google Workspace with Patronum"
        }
        description={
          "Achieve a unified experience with Google Workspace by using automated onboarding and offboarding platform. Manage users in bulk, cut costs, and streamline operations with **Google Workspace automation."
        }
        url={"on-boarding"}
        img={"onboarding.jpg"}
      ...
      <Layout>
        <main>
          <Hero
            ...
            pagePara={
              "Seamless & Automated User Lifecycle Management for Google Workspace."
            }
            boldpara=""
