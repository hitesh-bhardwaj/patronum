...
export default function Guides(){
    ...
    const GuidesCard = ( {imgSrc, title, para, link } ) => {
        return (
            <div className="guide-card hover:shadow-lg duration-300 w-[31.5%] overflow-hidden rounded-[10px] h-full border border-[#e8e8e8] bg-white">
                ...
                <div className="text-container px-[8%] py-[4%] pb-[12%] flex flex-col gap-[1.2vw]">
