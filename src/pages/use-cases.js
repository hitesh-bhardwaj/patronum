...
const useCasesData = [
  {
    ...
    para2:
      "By automating routine tasks, companies can enhance productivity, ensuring that every team member has the resources they need to succeed.",
  ...
  },
  {
    ...
    para2:
      "This digital transformation in HR not only saves time but also enhances the employee experience, reinforcing the organization's commitment to operational excellence and employee satisfaction.",
  ...
  },
  {
    ...
    para1:
      "Patronum is designed to help non-IT professionals directly control Google Workspace for their teams. With Patronum, marketing teams can centrally manage email signatures to ensure brand consistency, launch targeted marketing campaigns through shared contacts, and efficiently collaborate on shared drives.",
    para2:
      "These capabilities enable sales and marketing teams to present a unified brand to customers, streamline communication efforts, increase website traffic, generate leads, and drive sales through more effective marketing strategies.",
  ...
  },
  {
    ...
    para1:
      "Educational institutions can leverage Patronum to delegate administrative tasks effectively, manage classroom resources, and foster collaboration among students and faculty. Patronum can delegate IT administration within universities to faculty, department or course administration. School districts, groups of schools or academies benefit from predefined IT administration which can be tailored locally to their needs.",
    para2:
      "These tools simplify the management of educational content, enhance communication channels, and secure sensitive information, providing a safer, collaborative, and more productive learning environment.",
  ...
  return (
    <>
      <MetaData
        ...
        description={
          "With the help of Patronum, you can save time by avoiding those monotonous and repetitive tasks. Patronum will help with G Suite management in whichever field you are in be it IT, HR, Marketing, Sales, Users or Education."
        }
        url={"use-cases"}
        img={"use-cases.jpg"}
