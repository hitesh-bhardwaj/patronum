...
import PatronumForSalesHero from "@/components/Illustrations/PatronumForSalesHero";
const Faqs = dynamic(
  ...
  return (
    <>
      ...
      <MetaData
        ...
        description={
          "Patronum for Sales and Marketing transforms Google Workspace into a powerhouse for teams, enabling them to excel in the competitive sales arena while achieving targets and maintaining motivation, all without the constant need for IT intervention."
        }
      ...
      <Layout>
        <main>
          <Hero
            ...
            svgElement={<PatronumForSalesHero className={"h-full w-full"} />}
          />
