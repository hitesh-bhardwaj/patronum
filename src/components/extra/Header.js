...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left w-screen h-fit z-50'>
        <div className='container mt-5 px-3 bg-white shadow-linear rounded-full flex justify-between items-center mx-auto'>
            ...
            <nav>
                <ul className='flex gap-10 text-head font-medium'>
                    <li className='py-6 group'>
                        <a className='text-xl group-hover:text-primary duration-300 relative after:absolute after:w-full after:bg-primary after:-bottom-[2px] after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0' href='/about'>About</a>
                    </li>
                    <li className='py-6 group relative after:absolute after:w-full after:bottom-[-25px] after:pt-[50px]'
                        onMouseEnter={() => setFeaturesDropdownOpen(true)}
                        onMouseLeave={() => setFeaturesDropdownOpen(false)}
                        >
                        <a href='/features' className='flex relative items-center text-xl group-hover:text-primary duration-300 after:absolute after:w-full after:bg-primary after:bottom-0 after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0'>Features
                        ...
                        {isFeaturesDropdownOpen && (
                            <motion.div 
                                ...
                                className='absolute bg-white top-[85px] -left-[21vw] shadow-11xl bg-white text-white rounded-5xl w-max px-24 py-12'>
                                <ul className='relative grid grid-cols-2 gap-x-32 gap-y-6 w-full py-2 after:absolute after:top-0 after:left-1/2 after:bg-gray-200 after:rounded-full after:h-full after:w-[2px]'>
                                    <li>
                                        <a href='#' className='flex items-center gap-3 dropdown-list-hover'>
                    ...
                    <li className='py-6 group relative after:absolute after:w-full after:bottom-[-25px] after:pt-[50px]' 
                        ...
                        >
                        <a href='/use-cases' className='flex relative items-center text-xl group-hover:text-primary duration-300 after:absolute after:w-full after:bg-primary after:bottom-0 after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0'>Use Cases
                            <svg className='w-3 ml-2 h-3 mt-1' viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L6.5 6.5L12 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </a>
                        {isUsecasesDropdownOpen && (
                            <motion.div 
                                ...
                                animate={{ y: 0, opacity: 1 }}
                                transition={{ duration: 0.4 }} 
                                className='absolute bg-white top-[85px] left-[-22vw] shadow-11xl bg-white text-white rounded-2xl w-max px-24 py-12'>
                                <ul className='relative grid grid-cols-2 gap-x-32 gap-y-6 w-full py-2 after:absolute after:top-0 after:left-1/2 after:bg-gray-200 after:rounded-full after:h-full after:w-[2px]'>
                                    <li>
                                        <a href='#' className='flex items-center gap-3 dropdown-list-hover'>
                    ...
                    <li className='py-6 group'>
                        <a className='text-xl group-hover:text-primary relative duration-300 after:absolute after:w-full after:bg-primary after:-bottom-[3px] after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0' href='/pricing'>Pricing</a>
                    </li>
                    <li className='py-6 group relative after:absolute after:w-full after:bottom-[-25px] after:pt-[50px]' 
                        onMouseEnter={() => setResourcesDropdownOpen(true)}
                        onMouseLeave={() => setResourcesDropdownOpen(false)}
                        >
                        <a href='/resources' className='flex relative items-center text-xl group-hover:text-primary duration-300 after:absolute after:w-full after:bg-primary after:bottom-0 after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0'>Resources
                            <svg className='w-3 ml-2 h-3 mt-1' viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L6.5 6.5L12 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </a>
                        {isResourcesDropdownOpen && (
                            <motion.div 
                                ...
                                animate={{ y: 0, opacity: 1 }}
                                transition={{ duration: 0.4 }} 
                                className='absolute bg-white top-[85px] left-[-41vw] container flex shadow-11xl bg-white text-white rounded-2xl dropdown-point-2 w-max py-12 pl-0 pr-10'>
                    ...
                    <li className='py-6 group'>
                        <a className='text-xl group-hover:text-primary duration-300 relative after:absolute after:w-full after:bg-primary after:-bottom-[2px] after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0' href='/partners'>Partners</a>
                    </li>
                    <li className='py-6 group'>
                        <a className='text-xl group-hover:text-primary duration-300 relative after:absolute after:w-full after:bg-primary after:-bottom-[2px] after:h-[2px] after:left-0 after:duration-300 group-hover:after:scale-x-100 after:scale-x-0' href='/support'>Support</a>
                    </li>
                </ul>
            </nav>
            <div>
