                                ...
                                <div className="lg:flex items-start justify-between">
                                    <div className="md:mb-[15vw] mb-[10vw]">
                                        ...
                                        <div className="contact-information">
                                            <p className="lg:text-[1.25vw] md:text-[3vw] text-[4.5vw] md:w-[70%] w-full text-head flex items-start lg:mb-[2vw] mb-6 fadeUp">
                                                <span className="lg:mt-[0.45vw] mt-[1vw] mr-[10px] lg:w-[1vw] md:w-[2.5vw] w-[3.5vw]">
                                                    <Image className="w-full h-full" src="/assets/contact/location.svg" alt="location image" width={11} height={17}/>
                                                </span>
                                                <span>Mill B, Colne Road, Huddersfield, HD1 3AG United Kingdom</span>
                                            </p>
                                            <p className="lg:text-[1.25vw] md:text-[3vw] text-[4.5vw] md:w-[70%] w-full text-head flex items-start lg:mb-[2vw] mb-6 fadeUp">
                                                <span className="lg:mt-[0.45vw] mt-[1vw] mr-[10px] lg:w-[1vw] md:w-[2.5vw] w-[3.5vw]">
                                                    <Image className="w-full h-full" src="/assets/contact/phone.svg" alt="phone image" width={15} height={15}/>
                                                </span>
                                        ...
                                        <div className="social-media-icons mt-[3vw]">
                                            ...
                                            <ul className='inline-flex justify-between lg:w-[50%] lg:gap-0 md:gap-20 gap-10 items-center fadeUp text-black'>
                                        <li>
