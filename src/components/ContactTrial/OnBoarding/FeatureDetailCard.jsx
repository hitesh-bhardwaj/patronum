...
const FeatureDetailCards = ({ content, title1, title2 }) => {
  return (
    <section id="feature-detail-card">
      <div className="mx-auto lg:w-[80%] w-[90%] lg:px-[50px] max-w-full">
            ...
            {content.map((item, index) => (
              ...
              >
                ...
                <div
                  ...
                  "
                  style={{
                    border: `1px solid ${theme.colors.textHead}`,
                ...
                <div>
                  <h5
                    className="mb-[4vw] font-[500] text-[5vw] lg:mb-[1vw] lg:text-[1.5vw]"
                    style={{ color: theme.colors.textHead }}
                  >
                    {item.title}
                  </h5>

                  <p
                    className="px-[1vw] text-[4vw] font-[500] leading-[1.3] lg:text-[1vw]"
