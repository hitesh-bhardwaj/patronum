...
export default function ContactPageTrialForm() {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8  contact-page-form w-full aeonik ">
        {/* Form fields */}
        {/* Name field */}
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="required">
              <FormLabel className="relative after:content-['*'] after:text-primary  text-[4vw] lg:text-[1.2vw] md:text-[3vw]">Full Name</FormLabel>
              <FormControl>
        ...
        <FormField 
            ...
            render= {({ field }) => (
                <FormItem className="required">
                    <FormLabel className="relative after:content-['*'] after:text-primary text-[4vw] lg:text-[1.2vw] md:text-[3vw]">Business Email</FormLabel>
                    <FormControl>
        ...
        <FormField 
            ...
            render= {({ field }) => (
                <FormItem className="required">
                    <FormLabel className="relative after:content-['*'] after:text-primary text-[4vw] lg:text-[1.2vw] md:text-[3vw]">Company Name</FormLabel>
                    <FormControl>
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem className="required">
                    <FormLabel className="relative after:content-['*'] after:text-primary text-[4vw] lg:text-[1.2vw] md:text-[3vw]">Country</FormLabel>
                    <FormControl>
                        <CountrySelector
                            id={"country-selector"}
                            open={isOpen}
        ...
        {country === "IN" && (
            <FormField 
                ...
                render= {({ field }) => (
                    <FormItem className="required">
                        <FormLabel className="relative after:content-['*'] after:text-primary text-[4vw] lg:text-[1.2vw] md:text-[3vw]">Phone Number</FormLabel>
                        <FormControl>
        ...
        <FormField
          ...
          name="terms"
          render={({ field }) => (
            <FormItem className="terms !lg:mb-0">
                <div className="flex items-center gap-2 ">
                    ...
                    <FormLabel className="relative after:text-primary text-[4vw] lg:text-[1.2vw] md:text-[3vw]">
