...
const PinkButton = () => {
    ...
    return (
        <>
            <button aria-label="pop-up form open button" className={`${styles.btn} !bg-[#FF00AA] !w-[12.5vw] group !px-[2vw] !h-[3.9vw]`} onClick={() => openModal('contact')}>
                <span className={styles.btnText}>
                    Try for Free!
                </span>
                <div aria-hidden="true" data-pink className={`${styles.btnCircle} group-hover:!bg-primary group-hover:!text-white`}>
