...
const ScrollButton = ({ className="" }) => {
    ...
    return (
        <div className={`${styles.scrollDownBtn} ${className}`}>
            <button onClick={handleSmoothScroll} className={styles.scrollDownA} aria-label="Scroll Down">
                <svg width="86" height="86" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle className={`${styles.heroSvgCircle} hero-svg-circle`} cx="43" cy="43" r="42" stroke="currentColor" strokeWidth="1.5" />
                </svg>
