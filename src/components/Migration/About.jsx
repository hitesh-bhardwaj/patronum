                ...
                <div className="content-2">
                    <div className="lg:flex items-start justify-between">
                        ...
                        <p className="content-p lg:w-1/3 w-[95%] lg:mt-[1vw] mt-[5vw] text-anim-2">
                            <span>
                                Run multi-day migrations with confidence on infrastructure you choose - workstation, VM, or server. Patronum is not a hosted cloud service, and the path from setup through cutover stays predictable.
                            </span>
                        </p>
                    </div>
                    ...
                    <div className="lg:mt-[8vw] flex items-start justify-between flex-wrap mt-[15vw]">
                        {partnerCards.map((card) => (
                            ...
                            >
                                ...
                                <LinkButton href={card.href} btnText={card.buttonText} />
                            </div>
                        ))}
                    </div>
                </div>
