...
const Footer = () => {
    ...
    return(
        <div className="footer container mx-auto relative w-full">  

            <div className="footer-banner flex justify-center items-center overflow-hidden bg-[#062e63] rounded-5xl w-4/5 absolute bottom-[92%] left-1/2 -translate-x-1/2 z-10 py-14">
                <div className="relative z-10">
                    <h6 className="text-center text-white text-6xl font-head mb-10">Ready to become the master of your domain?</h6>
                    <div className="flex items-center justify-center gap-14">
                        <a href='#' className='group w-80 block transition-all duration-500 relative gap-10 px-6 py-5 border-white border-2 rounded-full hover:border-primary'>
                            <span className="absolute h-14 w-14 bg-white top-[10%] right-[3%] rounded-full -z-10 transition-all duration-500 group-hover:h-full group-hover:w-full group-hover:top-0 group-hover:right-0"></span>
                            <div className="h-full w-full flex items-center justify-between z-10 relative">
                                ...
                                <span className="w-7 overflow-hidden text-primary">
                                    <span className="transition-all duration-500 w-[200%] flex -translate-x-1/2 group-hover:translate-x-0">
