  ...
  return (
    <header className={isScrolled ? 'header scrolled' : 'header'}>
        <div className='header-container'>
            ...
            <div>
                <a data-v-157867a6="" href="/contact" className="btn relative inline-flex items-center h-50 px-35 rounded-full bg-primary text-white p3 font-medium">
                    <div data-v-157867a6="" className="btn__label">Install Patronum</div>
                    <div data-v-157867a6="" className="btn__circle absolute top-11 right-11 bg-white h-28 w-28 text-black flex items-center justify-center z-2">
                        <svg data-v-157867a6="" viewBox="0 0 21 23" fill="none" xmlns="http://www.w3.org/2000/svg" className="btn__icon h-10 w-10 overflow-hidden">
                            {/* <path data-v-157867a6="" fillRule="evenodd" clipRule="evenodd" d="M3.82475e-07 5.625L7.625 5.625L4.125 9.125L5 10L10 5L5 -4.37114e-07L4.125 0.874999L7.625 4.375L4.91753e-07 4.375L3.82475e-07 5.625Z" className="btn__path fill-current"></path> */}
