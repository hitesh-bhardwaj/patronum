                    ...
                    <div className="content flex justify-between items-center w-full h-full lg:flex-row flex-col-reverse lg:gap-unset gap-[10vw]">
                        <div className="about-left lg:w-[40%] w-full lg:text-left text-center">
                            ...
                            <p className="content-p mb-14 fadeUp">
                                As seasoned Google Workspace (GSuite) Managers ourselves, we understand the complexities and time constraints of managing an extensive digital workspace. That's precisely why we created Patronum - to transform the IT department's wish list into a robust reality.
                                <br />
                                <br />
                            ...
                            <PrimaryButton href="/about-us" btnText="Know More" />
