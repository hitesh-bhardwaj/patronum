                ...
                <div className="content flex justify-between items-center w-full h-full lg:flex-row flex-col-reverse lg:gap-unset gap-[10vw]">
                    <div className="about-left lg:w-[37%] w-full lg:text-left text-center">
                        ...
                        <p className="content-p mb-14 fadeUp">
                            ...
                            <br />
                            <br />
                            From user and group management to secure content sharing, from centralised email signatures to Google Workspace backups, Patronum empowers you to take control of your Google Workspace with unmatched ease and precision. Simplify your Google Workspace Management today!
                        </p>
