...
const Pricing = () => {
  ...
  const pricingCardWrapper = useRef(null);
  ...
  useEffect(() => {
    const pricingCards = pricingCardWrapper.current.querySelectorAll('.pricing-card');
    let ctx = gsap.context(() => {
      let tl = gsap.timeline({
        scrollTrigger: {
          trigger: pricingCardWrapper.current,
          start: "top 85%",
        }
      });
        ...
        <div className='container'>
          <div className='content'>
            ...
            <div className='pricing-main'>
              ...
              <div ref={pricingCardWrapper} className='pricing-card-wrapper'>
