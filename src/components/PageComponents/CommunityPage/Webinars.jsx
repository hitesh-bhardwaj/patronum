...
const Webinars = () => {
    ...
    return (
        ...
        <div onClick={() => openModal(videoId)}  className=" guide-card hover:shadow-xl duration-300 w-full h-full overflow-hidden rounded-[10px]  border-[0.67px]   cursor-pointer  border-[#e8e8e8] bg-white ">
            ...
            <div className="image-container w-full h-[50%] relative object-cover group-hover:scale-[1.03] scale-[1] duration-300">
                <img src={imgSrc} className="h-full w-full object-cover brightness-95" alt="Webinar Image" title="Webinar Image" />
